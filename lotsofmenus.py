...
# Create dummy user
User1 = User(name="Michael Eniolade", email="wisdomeniolade@gmail.com",
             picture='https://lh3.googleusercontent.com/-2nf7goH5S9E/'
             '-5kO8DI/AAAAAAAAABw/DD6j-Dgnr2YNlOk8Q2bHxgwu9pwpl2-LA/'
             'w140-h140-p/110508-195405.jpg')
session.add(User1)
session.commit()
...
menuItem2 = MenuItem
(user_id=1, name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",  # noqa
...
menuItem1 = MenuItem(user_id=1, name="French Fries", description="with garlic and parmesan",  # noqa
                     price="$2.99", course="Appetizer", restaurant=restaurant1)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(user_id=1, name="Chicken Burger", description="Juicy grilled chicken patty with tomato mayo and lettuce",  # noqa
                     price="$5.50", course="Entree", restaurant=restaurant1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(user_id=1, name="Chocolate Cake", description="fresh baked and served with ice cream",  # noqa
                     price="$3.99", course="Dessert", restaurant=restaurant1)

session.add(menuItem3)
session.commit()

menuItem4 = MenuItem(user_id=1, name="Sirloin Burger", description="Made with grade A beef",  # noqa
                     price="$7.99", course="Entree", restaurant=restaurant1)

session.add(menuItem4)
session.commit()

menuItem5 = MenuItem(user_id=1, name="Root Beer", description="16oz of refreshing goodness",  # noqa
...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     ...
                     "the skin and little meat, sliced in front of the diners by the cook",  # noqa
...
menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup",
                    description="A Chinese noodle soup made of stewed or red braised beef, "  # noqa
...
menuItem6 = MenuItem(user_id=1, name="Ramen",
                    ...
                    "and uses toppings such as sliced pork, dried seaweed, kamaboko,"  # noqa
                    "and green onions.",
                     price="12", course="Entree", restaurant=restaurant2)
...
menuItem1 = MenuItem(user_id=1, name="Pho", description="a Vietnamese noodle soup consisting of broth, "  # noqa
...
menuItem4 = MenuItem(user_id=1, name="Stinky Tofu",
                     ...
                     "deep fried fermented tofu served with pickled cabbage.",
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian",
                     ...
                     "a midly spiced soya,garlic sauce cooked with "
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     ...
                     "and slow cooked in a cylindrical clay or metal oven which"  # noqa
...
menuItem1 = MenuItem(user_id=1, name="Super Burrito Al Pastor",
                     description="Marinated Pork, Rice, Beans, Avocado, Cilantro,"  # noqa
                     "Salsa, Tortilla",
...
menuItem2 = MenuItem(user_id=1, name="Cachapa",
                     ...
                     "usually stuffed with queso telita or queso de mano, and possibly lechon. ",  # noqa
                     price="$7.99", course="Entree", restaurant=restaurant1)
